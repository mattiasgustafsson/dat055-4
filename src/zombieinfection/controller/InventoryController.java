...
public class InventoryController {
	 ...
	 * 
	 * @param inventory
	 *            the inventory object the inventory part of the GUI is going to
	 *            communicate with
	 */
	...
	/**
	 * Handles the event that one of the food slots in the GUI is clicked. If the
	 * food slot contains the name of a food item it is removed from the GUI and
	 * from the Inventory. The health gain of the food item is added to the health
	 * of the player.
	 * 
	 * @param name
	 *            the text written on the clicked food slot button
	 */
