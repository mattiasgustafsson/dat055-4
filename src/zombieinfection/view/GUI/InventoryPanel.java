...
public class InventoryPanel extends JPanel implements PropertyChangeListener {
     ...
     *
     * @param ic the controller object that handles the communication between
     * this object an the model object
     */
    ...
    /**
     * Update inventory part of GUI when values changes in the corresponding
     * parts of the model.
     */
    @Override
