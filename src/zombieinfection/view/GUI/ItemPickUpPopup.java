...
/**
 * The ItemPickUpPopip class represents the pop-up panel that appears when
 * picking up items in game.
 *
        ...
        for (Component comp : checkBoxes.getComponents()) {
            ...
            if (comp instanceof JCheckBox) {
                ...
                if (((JCheckBox) comp).isSelected()) {
                    ...
                    boolean itemFits = GameEngine.getInstance().getPlayer().getInventory().itemFits(itemToPickUp);
