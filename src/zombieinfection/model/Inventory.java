...
public class Inventory {
	...
	/**
	 * Returns boolean depending on if the parameter item has a weight low enough to
	 * fit in the player's current inventory and if the player is not carrying too
	 * many items of the same type as the item given as a parameter.
	 * 
	 * @param item
	 *            the item to be checked if it fits in the inventory
	 * @return <code>true</code> if the item would fit in the inventory and the
	 *         player is not carrying too many items of the same type as the
	 *         parameter item; <code>false</code> if the item is too heavy to fit in
	 *         the inventory or if there are already too many items of the same type
	 *         as the parameter item in the inventory
	 */
	...
	/**
	 * Returns the damage the strongest armour currently in the inventory is able to
	 * take. Returns 0 if there is no armour in the inventory.
	 * 
	 ...
	 * 
	 * @param item
	 *            the item that should be added to the player's inventory
	 */
	 ...
	 * 
	 * @param item
	 *            the item that should be removed from the player's inventory
	 */
	...
	/**
	 * Returns boolean depending on if there is an item in the inventory that has
	 * the named that is passed to the method as a parameter
	 * 
	 * @param name
	 *            the name of an item we want to check is in the inventory or not
	 ...
	 * 
	 * @param i
	 *            the item we want to know is in the inventory or not
