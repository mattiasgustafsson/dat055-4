...
public class Room {
    ...
    /**
     * Sets one of the exits of the Room so that if you exit the Room in
     * "direction" you reach "neighbor".
     *
     * @param direction	The direction of the exit
     * @param neighbor	The neighboring Room that the exit leads to
     * @return	FALSE if direction isn't valid or neighbor is null. Returns TRUE
     * if successful.
     */
    ...
    /**
     * Returns what Room is reached when exiting this Room in a specific
     * direction.
     *
     * @param direction	The direction of the exit.
     ...
     * @return	TRUE if the Room has an exit in the given direction, FALSE if it
     * doesn't.
     */
