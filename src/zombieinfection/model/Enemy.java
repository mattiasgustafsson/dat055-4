...
public class Enemy {
	 ...
	 * 
	 * @param name
	 *            the name this enemy object should have
	 */
	...
	/**
	 * Used to "interact" with an enemy and decides if the enemy will attack or not
	 * when the player interacts with it. If the enemy decides to attack the
	 * attack-method is called.
	 * 
	 * @return <code>true</code> if the enemy attacks; <code>false</code> otherwise
	 */
	...
	/**
	 * Used to make enemy attack player and do damage to player's health. The damage
	 * the enemy does to the players health is its strength minus the damage of the
